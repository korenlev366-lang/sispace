...
import { runHarnessReflect } from "../scripts/pipeline-lib.mjs";
import { runPipelineStreaming } from "./pipeline-run.mjs";
import { runSwarmCreate } from "../scripts/swarm-lib.mjs";
...
if (obsidianMcpConfigured() && cursorAgent.available) {
  console.log("OpenClaw hybrid: enabled (Obsidian MCP + cursor-agent)");
} else if (obsidianMcpConfigured()) {
